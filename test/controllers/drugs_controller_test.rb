...
class DrugsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drug" do
    assert_difference('Drug.count') do
      post drugs_url, params: { drug: { drug_id: @drug.drug_id, name: @drug.name, price: @drug.price, stock: @drug.stock, unit: @drug.unit } }
    end
  ...
  test "should update drug" do
    patch drug_url(@drug), params: { drug: { drug_id: @drug.drug_id, name: @drug.name, price: @drug.price, stock: @drug.stock, unit: @drug.unit } }
