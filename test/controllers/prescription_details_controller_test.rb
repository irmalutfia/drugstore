...
class PrescriptionDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription_detail" do
    assert_difference('PrescriptionDetail.count') do
      post prescription_details_url, params: { prescription_detail: { drug_id: @prescription_detail.drug_id, prescription_id: @prescription_detail.prescription_id, price: @prescription_detail.price, qty: @prescription_detail.qty } }
    end
  ...
  test "should update prescription_detail" do
    patch prescription_detail_url(@prescription_detail), params: { prescription_detail: { drug_id: @prescription_detail.drug_id, prescription_id: @prescription_detail.prescription_id, price: @prescription_detail.price, qty: @prescription_detail.qty } }
