...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post prescriptions_url, params: { prescription: { nama_apoteker: @prescription.nama_apoteker, nama_dokter: @prescription.nama_dokter } }
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { nama_apoteker: @prescription.nama_apoteker, nama_dokter: @prescription.nama_dokter } }
