...
class PaymentDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_detail" do
    assert_difference('PaymentDetail.count') do
      post payment_details_url, params: { payment_detail: { cash: @payment_detail.cash, date: @payment_detail.date, debt: @payment_detail.debt, drug_id: @payment_detail.drug_id, qty: @payment_detail.qty, unit: @payment_detail.unit } }
    end
  ...
  test "should update payment_detail" do
    patch payment_detail_url(@payment_detail), params: { payment_detail: { cash: @payment_detail.cash, date: @payment_detail.date, debt: @payment_detail.debt, drug_id: @payment_detail.drug_id, qty: @payment_detail.qty, unit: @payment_detail.unit } }
